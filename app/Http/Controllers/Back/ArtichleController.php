...
class ArtichleController extends Controller
{
    /**
    ...
    public function store(ArticleRequest $request)
    {
        ...
        $file = $request->file('img'); //memanggil img/gambar
        $fileName = uniqid().'.'.$file->getClientOriginalExtension(); //sesuai dengan nama foldernya (jpg,png, jpeg dan lain-lain)
        $file->storeAs('public/back/', $fileName); //ini untuk memanggil nama gambarnya
        ...
        return redirect(url('article'))->with('success', 'Data Article has benn created');
    ...
    public function update(UpdateArticleRequest $request, string $id)
    {
        ...
        return redirect(url('article'))->with('success', 'Data Article has benn updated');
